...
$sql = $cn->query("SELECT * FROM acreedor  WHERE id = '$id'");
                    ...
                    while ($f = mysqli_fetch_assoc($sql)) {
                            ...
                            <input type="hidden">'.utf8_encode($f[""]).'
                            <td style=text-align: justify;>
                                        '.utf8_encode($f["tipo_documento"]).'
                                    ';

                            if ($f["tipo_documento"] == "nit") {
                            	echo'<span class="badge badge-warning">Jurídica</span>';
                            }else {
                            	echo'<span class="badge badge-primary">Natural</span>';
                            };
                            '</td>';
...
<p class=" text-center alert alert-primary alert-large" role="alert">ADJUNTE FECHA Y  DOCUMENTOS DE RESPALDO DE LA CARTERA <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target=".bd-insert-document">AÑADIR</button>
...
<div class="modal fade bd-insert-document" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="container my-3">
      	<form  action="registrarcartera.php" method="POST" class="m-auto  my-2 col-lg-12 col-md-10 text-center text-uppercase border" name="form">
...
<p class=" text-center alert alert-primary alert-large my-2" role="alert">ADJUNTE  DOCUMENTOS DE RESPALDO DE LA CARTERA <input type="button" class="btn btn-success pull-right btn-sm"  value="+"  onclick="mostrar_mas(this)">
   ...
   GUARDAR</button> 
    <button type="button" class="btn btn-danger"><i class="fas fa-eraser"></i>CERRAR</button>
 </div>
    </form>
    </div>
    </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required type="text" value="" class="form-control" id=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input required type="text" class="form-control"
                                    aria-label="Dollar amount (with dot and two decimal places)" name="capital"
                                    id="capital" value="" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input required type="number" class="form-control"
                                    aria-label="Dollar amount (with dot and two decimal places)" name="interes"
                                    id="interes"
                                    value="0">
                                <div class="input-group-append">
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input required type="text" class="form-control" id="honorarios" placeholder="CAPITAL"
                                    name="honorarios" value="23" readonly>
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input required type="text" class="form-control" id="gastos" placeholder="CAPITAL"
                                    name="gastos" readonly="" value="12">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input required type="number" class="form-control"
                                    aria-label="Dollar amount (with dot and two decimal places)" name="descuento"
                                    id="descuento"
                                    value="0">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                    ...
                    <div class="col-sm-12 text-justify">
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input required class="form-check-input" type="radio" name="sancion" id="sancion"
                                    value="20">
                                <label class="form-check-label" for="inlineRadio1"> SI </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input required class="form-check-input" checked type="radio" name="sancion"
                                    id="sancion" value="0">
                    ...
                    <div class="col-12">
                        <button type="button" name="btn-total"
                            class="btn btn-primary d-flex justify-content-sm-end my-2" id="btn_get_total">SACAR
                            TOTAL</button>
                    </div>
                    <div class="col-12">
        ...
        if (btn_total) {
            btn_total.addEventListener('click', function (e) {
                ...
                if (!capital) {
                 ...
                 // if (!capital || !por_interes ||
                //     !por_honorarios || !por_gastos || !por_descuento) {
                //     alert("Algunos datos son requerido para el total")
                //     return false
                // }
